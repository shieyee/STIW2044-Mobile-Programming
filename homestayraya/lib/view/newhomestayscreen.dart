...
class NewHomestay extends StatefulWidget {
  ...
  @override
  State<NewHomestay> createState() => _NewHomestayState();
}
...
class _NewHomestayState extends State<NewHomestay> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("New Homestay/Service"),
        ),
...
// return object of type Dialog
  ...
  // void checkPermissionGetLoc() async {
  //   bool serviceEnabled;
  ...
  //     homestaylocalEditingController.text = placemarks[1].locality.toString();
  //   });
  // }
